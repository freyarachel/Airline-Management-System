...
public class Update_Journey_Details extends JFrame{ 

    
	JTextField textField,textField_1,textField_2,textField_3,textField_4,textField_5,textField_6;

        public Update_Journey_Details(){
            getContentPane().setForeground(Color.BLUE);
            getContentPane().setBackground(Color.WHITE);
            setTitle("Update_Journey_Info");
		 
            setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);
            setSize(778,486);
            getContentPane().setLayout(null);
			
            JLabel PnrNo = new JLabel("Enter PNR NO of passenger to update journey details");
            PnrNo.setFont(new Font("Tahoma", Font.PLAIN, 17));
            PnrNo.setBounds(20, 100, 500, 27);
            add(PnrNo);
            ...
            JLabel AddPassengers = new JLabel("UPDATE JOURNEY DETAILS");
            ...
            Next.addActionListener(new ActionListener(){
                public void actionPerformed(ActionEvent ae){
                    ...
                    try {
                        conn c = new conn();
                        String str = "UPDATE reservation SET ticket_id = '"+ticket_id+"',f_code = '"+f_code+"',jny_date = '"+jny_date+"',jny_time = '"+jny_time+"',src = '"+src+"',dst = '"+dst+" WHERE pnr_no = '"+pnr_code+"'";
                        c.s.executeUpdate(str);
                        JOptionPane.showMessageDialog(null,"Journey Details Updated");
                        setVisible(false);
