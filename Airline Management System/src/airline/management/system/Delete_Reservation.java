...
public class Delete_Reservation extends JFrame{  
	...
	new Delete_Reservation().setVisible(true);    
    }
	...
	JLabel FlightDetails = new JLabel("DELETE RESERVATION INFORMATION");
	FlightDetails.setFont(new Font("Tahoma", Font.PLAIN, 28));
	FlightDetails.setForeground(new Color(100, 149, 237));
	FlightDetails.setBounds(30, 20, 570, 35);
	add(FlightDetails);
	...
	add(btnShow);
        ...
        btnShow.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                ...
                try {
                    conn c = new conn();
                    String str = "delete from reservation where pnr_no = '"+code+"'";
