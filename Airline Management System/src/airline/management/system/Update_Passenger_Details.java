...
public class Update_Passenger_Details extends JFrame{ 

	JTextField textField,textField_1,textField_2,textField_3,textField_4,textField_5,textField_6;

        public Update_Passenger_Details(){
            ...
            JLabel Pnrno = new JLabel("Enter PNR NO of the passenger to be updated");
            Pnrno.setFont(new Font("Tahoma", Font.PLAIN, 17));
            Pnrno.setBounds(20, 80, 500, 27);
            add(Pnrno);
            ...
            JLabel AddPassengers = new JLabel("UPDATE CUSTOMER DETAILS");
            AddPassengers.setForeground(Color.GREEN);
            AddPassengers.setFont(new Font("Tahoma", Font.PLAIN, 31));
            AddPassengers.setBounds(110, 24, 442, 35);
            add(AddPassengers);
			
    
            JLabel Flightcode = new JLabel("FLIGHT CODE");
            Flightcode.setFont(new Font("Tahoma", Font.PLAIN, 17));
            Flightcode.setBounds(150, 160, 150, 27);
            add(Flightcode);

            textField_6 = new JTextField();
            textField_6.setBounds(300, 160, 150, 27);
            add(textField_6);
            ...
            Next.addActionListener(new ActionListener(){
                public void actionPerformed(ActionEvent ae){
                    ...
                    try {
                        conn c = new conn();
                        String str = "UPDATE passenger SET address = '"+address+"',nationality = '"+nationality+"',name = '"+name+"',gender = '"+gender+"',ph_no = '"+ph_no+"',passport_No = '"+passport_No+"',fl_code = '"+fl_code+"' WHERE pnr_no = '"+pnr_no+"'";
