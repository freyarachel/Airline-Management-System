...
public class Delete_Passenger extends JFrame{  

    private JTextField textField;
    
    public static void main(String[] args){		 
	new Delete_Passenger().setVisible(true);    
    }
    
    public Delete_Passenger(){
	...
	add(btnShow);
        ...
        btnShow.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                ...
                try {
                    conn c = new conn();
                    String str = "delete from passenger where pnr_no = '"+code+"'";
